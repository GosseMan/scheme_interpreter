...
int main() {
	...
	while (1) {
		...
		/*
		cout << "] ";
		cout << "Free-list�� root node index : " << Alloc() << endl;
		cout << "Memory array�� root node index : " << root << endl << endl;
		cout << "<HashTable>" << endl;
		...
		cout << "   NodeID  l   Lchild   l   Rchild   ��  FreeList" << endl;
		cout << "----------------------------------------------------" << endl;
